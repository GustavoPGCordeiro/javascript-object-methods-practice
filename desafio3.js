...
//Adicione um método chamado calcularMediaNotas ao objeto pessoa. Este método deve 
//calcular a média das notas da pessoa.
...
//Chame o método calcularMediaNotas para calcular a média das notas da pessoa e imprima no console 
//a média calculada.
//Chame o método classificarDesempenho e imprima no console a categoria de desempenho da pessoa.

const pessoa = {
    nome: "Gustavo Cordeiro",
...
console.log(`A média de ${pessoa.nome} foi: ${pessoa.calcularMediaNotas}.
    Seu desempenho ficou como: ${pessoa.classificarDesempenho}`)
...
carro.propriedadeAdicional = {
    preco: 850000

}

for(let propriedadeNova in carro){
console.log(`${propriedadeNova}: ${carro[propriedadeNova]}`)
}
...
//obterDetalhes: um método que retorna uma string contendo todos os detalhes 
//do carro (marca, modelo, ano, cor, estado de ligado/desligado).
...
//Utilize o método Object.keys() para obter um array contendo apenas as chaves enumeráveis 
//do objeto carro e imprima no console esse array.
...
//Crie um novo objeto chamado carroNovo para representar as informações de um novo carro. O objeto deve 
...
//Modifique o valor de uma propriedade no objeto carroComNovosDetalhes e imprima novamente o objeto no console
